        ...
        <div class="modal-body">
          ...
          >
            ...
            <div class="text-start">
              ...
              <div class="small fw-lighter">Maak een kopie van jouw data als back-up</div>
            </div>
          </div>
          <hr />
          <div class="btn btn-dark d-flex align-items-center gap-3 py-3 px-3" @click="clearStorage">
          ...
          <hr />
          <div class="btn btn-dark d-flex align-items-center gap-3 py-3 px-3" @click="selectFile">
