            ...
            <div class="row align-items-center g-2">
                ...
                <div class="col-2 col-md-3 d-none d-sm-block">
                    <div class="d-flex gap-3 align-items-center h-100">
                        ...
                        <router-link class="text-decoration-none d-flex align-items-center gap-2" to="/">
                            <img alt="Logo" src="../assets/img/lekker_speuren_logo.png" width="40px">
                            <span class="d-none text-light d-md-block special-elite-regular lh-1 text-truncate">Lekker Speuren</span>
                        </router-link>
                    </div>
                </div>
                ...
                <div class="col">
                    ...
                    <div class="d-none d-sm-flex gap-2 align-items-center">
                        <div :class="{ 'focus-margin' : !focus }" class="input-group flex-nowrap">
                            ...
                            <button class="input-group-text rounded-end-pill px-4" title="Search" type="button"
                                    @click="doSearch"><i
                                class="bi bi-search"></i></button>
                        </div>
                        <filter-modal/>
                        <button :class="{active : view === 'random' }" class="btn btn-dark btn-circle rounded-circle"
                                title="Toggle random view" type="button"
                                @click="toggleView"><i class="bi bi-dice-5"></i></button>
                    </div>
                    <!-- search mobile -->
                    <div v-if="mobileSearch" class="d-flex d-sm-none gap-2 justify-content-end align-items-center">
                        <div>
                            <button class="btn btn-dark btn-circle rounded-circle" type="button"
                                    @click="mobileSearch = false;"><i
                    ...
                    <div class="d-flex gap-2 align-items-center justify-content-end">
                        ...
                        <a href="https://github.com/lekkersicko/lekker-speuren" target="_blank"
                           title="View project on GitHub">
                            <button class="btn btn-dark btn-circle rounded-circle" title="Change theme" type="button"><i
                        ...
                        <div class="dropdown">
                            <button
                                ...
                                class="btn btn-dark btn-circle rounded-circle" data-bs-display="static"
                ...
                <div class="d-sm-none col-auto col-sm-3">
                    <div class="d-flex gap-2 align-items-center justify-content-end">
                        <!-- Github -->
                        <a v-if="!mobileSearch" href="https://github.com/lekkersicko/lekker-speuren" target="_blank"
                           title="View project on GitHub">
                            <button class="btn btn-dark btn-circle rounded-circle" title="Change theme" type="button"><i
                                class="bi bi-github"></i></button>
                        </a>
                        ...
                        <button v-if="!mobileSearch" :class="{active : view === 'random' }"
                                class="d-sm-none btn btn-dark btn-circle rounded-circle" type="button"
                                @click="toggleView"><i class="bi bi-dice-5"></i></button>
                        <!-- search -->
