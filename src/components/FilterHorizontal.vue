...
/**
 * Look for the label of the current date filter
 * @type {ComputedRef<*>}
 */
...
/**
 * Look for the label of the current type filter
...
/**
 * Look for the label of the current platform filter
 * @type {ComputedRef<string|[string]|*>}
 */
...
/**
 * Look for the label of the current duration filter
 * @type {ComputedRef<*>}
 */
const duration_label = computed(() => {
    ...
    return item ? item.label : filters.value.duration;
});
