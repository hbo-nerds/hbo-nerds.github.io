<template>
    <div class="card h-100 border-0 bg-transparent">
        ...
        <div class="img-wrapper position-relative" type="button" @click="goToCard" @click.middle="goToCard('middle')">
            ...
            <div class="transform-wrapper position-relative">
                ...
                <span class="badge bg-black position-absolute bottom-0 end-0 m-2"
                      style="--bs-bg-opacity: .75;"><i class="bi bi-collection-play me-1"></i>
                    {{ playlist['items'].length }} {{ playlist['items'].length > 1 ? 'items' : 'item' }}
                </span>
            </div>
