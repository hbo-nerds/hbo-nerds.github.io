    ...
    <div class="card" @click="goToCard"
        ...
        <div class="card-body">
            ...
            card.type === 'video' ? 'border-yt' : 'border-tw'">
                        <img class="w-100" v-lazy="{ src: images['320'][`${imgName}`] || images['320'][`default`], loading: 'Loading your image'}" alt="thumbnail">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="content-wrapper h-100 d-flex flex-column">
                                <a v-if="card['twitch_id']" :href="'https://www.twitch.tv/videos/' + card['twitch_id']"
                                   class="me-2 mb-2" target="_blank">
                                    <img style="width: 32px;height: 32px" src="../assets/img/twitch.png" alt="logo">
                                </a>
                                <a v-if="card['youtube_id']" :href="'https://youtube.com/watch?v=' + card['youtube_id']"
                                   class="me-2 mb-2" target="_blank">
                                    <img style="width: 32px;height: 32px" src="../assets/img/youtube.png" alt="logo">
                                </a>
                                <a v-if="card['twitchtracker_id']" :href="'https://twitchtracker.com/lekkerspelen/streams/' + card['twitchtracker_id']"
                                   class="mt-auto" target="_blank">
                                    TwitchTracker
                                </a>
                            </div>
                        </div>
