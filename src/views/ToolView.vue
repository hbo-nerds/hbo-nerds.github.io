        ...
        <div class="row justify-content-center">
            <div class="col col-md-8">
                ...
                <div class="pt-4 mb-4">
                    ...
                    <button v-if="!files" class="btn btn-light rounded-pill" @click="selectFile">Selecteer bestand
                    </button>
                    <template v-else>
                        <button class="btn btn-light rounded-pill me-2" @click="uploadUserData">Upload bestand
                    ...
                    <input id="formFile" ref="fileInput" accept=".json" class="d-none" type="file"
