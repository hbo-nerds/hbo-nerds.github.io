            ...
            <div class="col col-md-8">
                <div class="card mb-5">
                    <div class="card-body">
                        <div>
                            <h2>Data uploaden</h2>
                            <p>Wat fijn dat je ons weer hebt gevonden! Upload hier het bestand dat je hebt gedownload
                                van de oude website en druk op de knop om je data in te laden en weer op te slaan.</p>
                            <div class="input-group">
                                <input id="formFile" accept=".json" class="form-control" type="file">
                                <button class="btn btn-primary" type="button" @click="uploadUserData">Laad mijn data
                                </button>
                            </div>
                            <div v-if="waiting" class="spinner-border mt-3" role="status">
                                <span class="visually-hidden">Loading...</span>
                            </div>
                            <div v-if="success" class="alert alert-success alert-dismissible fade show mt-3 mb-0"
                                 role="alert">
                                <i class="bi bi-hand-thumbs-up-fill me-2"></i>Data succesvol ingeladen en opgeslagen!
                                <button aria-label="Close" class="btn-close" data-bs-dismiss="alert" type="button"
                                        @click="success = false"></button>
                            </div>
                            <div v-if="invalid" class="alert alert-danger alert-dismissible fade show mt-3 mb-0"
                                 role="alert">
                                <i class="bi bi-hand-thumbs-down-fill me-2"></i>Geen bruikbare data gevonden. Heb je het
                                juiste bestand geupload?
                                <button aria-label="Close" class="btn-close" data-bs-dismiss="alert" type="button"
