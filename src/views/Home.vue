<template>
  <!-- main -->
  <main class="pb-5">
    <div class="d-none d-sm-flex align-items-center flex-wrap gap-2 sticky-top z-1 bg-body py-3">
      ...
      <span class="d-flex align-items-baseline gap-2">
        ...
        <span class="small"
          ...
          <img alt="lekker_appie" height="20" src="@/assets/img/lekkerAppie_V2.png" /> Lees
