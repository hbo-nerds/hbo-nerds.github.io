<template>
    ...
    <template v-if="view === 'search'">
        <div class="row">
            <div class="col">
                <div class="row g-3 mb-5" :class="selectedCardId ? 'row-cols-1 row-cols-xl-2 row-cols-xxl-3 row-cols-3xl-4 row-cols-4xl-5' : 'row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-3xl-5 row-cols-4xl-6'">
            ...
            <div class="col-6 col-xl-4" v-if="selectedCard">
                <div class="sticky-top">
                    <div class="d-flex align-items-center mb-3">
                        <button @click="selectedCardId = null" type="button" class="btn-close" aria-label="Close"></button>
                    </div>
