...
export default defineConfig({
    plugins: [vue(), VitePWA({
        registerType: 'autoUpdate', injectRegister: 'auto', includeAssets: ["**/*"], devOptions: {
            enabled: true
        }, workbox: {
            ...
            description: 'Introducing Lekker Speuren. Een database van ALLE Lekker Spelen content waar je vliegensvlug doorheen kan speuren.',
            icons: [{
            ...
            screenshots: [
                {
                    "src": "/screenshots/ls_home.png",
                    "sizes": "720x627",
                    "form_factor": "wide",
                    "label": "Zoek naar VOD's van de malle makkers."
                },
                {
                    "src": "/screenshots/ls_series.png",
                    "sizes": "720x627",
                    "form_factor": "wide",
                    "label": "Bekijk series voor een malle marathon."
                },
                {
                    "src": "/screenshots/ls_profile.png",
                    "sizes": "720x627",
                    "form_factor": "wide",
